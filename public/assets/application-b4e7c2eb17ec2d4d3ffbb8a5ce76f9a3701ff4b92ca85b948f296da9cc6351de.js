...
(function() {
  window.post_comment_btn = function(btn) {
    var comment_name, new_comment_block, new_comment_input, tweet_id;
  ...
  window.comment_trash = function(comment_id) {
  ...
  window.comment_toggle_like = function(comment_id) {
    return $.ajax({
...
(function() {
  ...
  window.fbAsyncInit = function() {
    ...
    return $('#sign_out_facebook').click(function(e) {
      FB.getLoginStatus(function(response) {
        if (response.authResponse) {
          return FB.logout();
        }
...
var nicEditorConfig = bkClass.extend({
	...
	iconList : {"bold":1,"center":2,"hr":3,"indent":4,"italic":5,"justify":6,"left":7,"ol":8,"outdent":9,"removeformat":10,"right":11,"save":18,"strikethrough":13,"subscript":14,"superscript":15,"ul":16,"underline":17}
...
(function() {
  window.tweet_trash = function(tweet_id) {
  ...
  window.tweet_comment = function(tweet_id) {
    var jNewComment;
    jNewComment = $('.single-tweet[data-tweet-id="ID"] .new-comment'.replace('ID', tweet_id));
    return jNewComment.toggle();
  };

  window.tweet_toggle_star = function(tweet_id) {
    return $.ajax({
  ...
  window.tweet_toggle_like = function(tweet_id) {
    return $.ajax({
  ...
  $(function() {
    $("#post_btn").click(function() {
      ...
      if (post_name.length > 2800) {
        return alert("post is too long, make it shorter!");
      } else {
    ...
    $('#post_name').keyup(function(event) {});
    $('.tweet-name').emoticonize({
      delay: 800,
      animate: true
    });
    $('.comment-name').emoticonize({
      delay: 1200,
      animate: true
    });
    $('.well').emoticonize();
    $('.btn-emoticons-collapser').emoticonize({
      delay: 0,
      animate: false
    });
    return $('#collapseEmoticons .animated-emoticon').click(function() {
      var emoticon_code;
      emoticon_code = $(this).text();
      return $('#tweet_text_input').append(" " + emoticon_code + " ");
    });
  });
